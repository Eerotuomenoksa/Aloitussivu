...
Käynnissä. Osoite rajatulle digiopastaja- ja testaajaryhmälle, ei julkista tiedotusta. Tavoite: ensimmäiset havainnot ja Eeron video.

### Vaihe 1 — Digiopastajat (1.9.–8.9.)

Valmiit tekstit A–D käyttöön. Lisäksi:
...
Kaksi luontaista huippua: **Vanhustenviikko** (lokakuun alku — tarkista tarkat päivät) ja **joulu**.
...
| Aika | Toimenpide |
| --- | --- |
| 31.8. | Ennakkotieto digiopastajille |
| 1.9. | Julkaisu, tekstit A–D |
| 1.–8.9. | Some, A5-kortit opastajille |
| 9.9. | Juttunetin avaus — ei omaa tiedotusta, vastavuoroiset linkit |
| syyskuu | Kuukausirytmi käyntiin opastajien kirjeessä |
| lokakuu | Juttunetin videoryhmä; Vanhustenviikko; A4 pankkeihin ja kirjastoihin |
...
## 9. Ensimmäiset viisi tehtävää

1. Taita A5-kortti opastajille ja tilaa ensimmäinen erä.
2. Kirjoita ja taita A4 "Näin asetat läheisellesi aloitussivun".
3. Sovi Juttunetin kanssa vastavuoroiset linkit ja lokakuun videoryhmä.
4. Lisää kuukausirytmin kaksi kohtaa digiopastajien kirjeen vakiorakenteeseen.
5. Varmista, että `?src=`-parametri on toteutettu ennen kuin ensimmäinen painettu QR-koodi lähtee tuotantoon.
