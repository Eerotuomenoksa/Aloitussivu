...
export const AUGUST_2026_HIGHLIGHTS: ChangelogHighlight[] = [
  {
    ...
    changes: [
      ...
      'Kaikkien 308 kunnan virallisilta sivuilta kartoitettiin omat seniori- tai ikäihmisten sivut. Sovellukseen tuotiin 70 korkean varmuuden kuntalinkkiä, ja Mäntsälä ohjaa suoraan kunnan Seniorityö-sivulle.',
      'Tilastokeskuksen vuoden 2025 ikärakenteella laskettuna näissä 70 kunnassa asuu 364 275 vähintään 65-vuotiasta. Se on 27,0 % koko Suomen 1 347 494 henkilön 65+ väestöstä.',
