    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          paragraph('Palautteet näkyvät vain nimetyille ylläpitäjille. Kuvat säilytetään suojatussa paikassa. Ne eivät näy ulkopuolisille.'),
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          paragraph('Responsen syns bara för namngivna administratörer. Bilderna förvaras på en skyddad plats. De syns inte för utomstående.'),
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          paragraph('Feedback is visible only to named administrators. Pictures are kept in a protected place. They are not visible to outsiders.'),
