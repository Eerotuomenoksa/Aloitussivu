...
return [
    'app' => [
        'environment' => 'staging',
        'origin' => 'https://staging.aloitussivu.seniorsurf.fi',
        'base_path' => '',
        'require_https' => true,
        'trust_proxy' => false,
    ...
    'database' => [
        'dsn' => 'mysql:host=dbtma.db.cchosting.fi;port=3306;dbname=dbtma_aloitussivu;charset=utf8mb4',
        'username' => 'REPLACE_WITH_STAGING_DATABASE_USER',
        'password' => '',
    ],
    'logging' => [
