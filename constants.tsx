...
export const SHORTCUTS: Shortcut[] = [
  ...
  },
  {
    ...
    providers: [
      { name: 'Åbo Svenska Teater', url: 'http://www.abosvenskateater.fi/sv/start/', group: 'Turku' },
      { name: 'Ahaa Teatteri', url: 'http://www.ahaateatteri.com', group: 'Tampere' },
      { name: 'Aurinkobaletti', url: 'http://www.aurinkobaletti.fi/', group: 'Turku' },
      { name: 'Cirko – Uuden sirkuksen keskus', url: 'http://www.cirko.fi/', group: 'Helsinki' },
      { name: 'Compañía Kaari & Roni Martin', url: 'https://www.compania.fi/' },
      { name: 'Espoon teatteri', url: 'http://www.espoonteatteri.fi/', group: 'Espoo' },
      { name: 'Greta Tuotanto', url: 'https://www.gretatuotanto.fi/' },
      { name: 'Hämeenlinnan Teatteri', url: 'http://www.hmlteatteri.fi/', group: 'Hämeenlinna' },
      ...
      { name: 'JoJo – Oulun Tanssin Keskus', url: 'http://jojo.fi/', group: 'Oulu' },
      { name: 'Jyväskylän kaupunginteatteri', url: 'https://www.jklteatteri.fi/', group: 'Jyväskylä' },
      { name: 'Kajaanin kaupunginteatteri', url: 'http://www.kajaaninteatteri.fi/', group: 'Kajaani' },
      { name: 'Kemin teatteri', url: 'http://www.keminteatteri.fi/', group: 'Kemi' },
      ...
      { name: 'Kotkan Kaupunginteatteri', url: 'http://www.kotkanteatteri.fi/', group: 'Kotka' },
      { name: 'Kouvolan Teatteri', url: 'http://www.kouvolanteatteri.fi/', group: 'Kouvola' },
      { name: 'Kuopion kaupunginteatteri', url: 'http://kuopionkaupunginteatteri.fi/', group: 'Kuopio' },
      { name: 'Lahden kaupunginteatteri', url: 'http://www.lahdenkaupunginteatteri.fi/', group: 'Lahti' },
      { name: 'Läntinen tanssin aluekeskus', url: 'https://l-tanssi.fi/', group: 'Turku' },
      { name: 'Lappeenrannan kaupunginteatteri', url: 'http://lprteatteri.fi/fi', group: 'Lappeenranta' },
      { name: 'Linnateatteri', url: 'https://linnateatteri.fi/', group: 'Turku' },
      { name: 'Mikkelin Teatteri', url: 'http://www.mikkelinteatteri.fi/', group: 'Mikkeli' },
      { name: 'Musiikkiteatteri Kapsäkki', url: 'https://kapsakki.fi/', group: 'Helsinki' },
      { name: 'Nukketeatteri Sampo', url: 'http://nukketeatterisampo.fi/', group: 'Helsinki' },
      { name: 'Oulun teatteri', url: 'http://teatteri.ouka.fi/', group: 'Oulu' },
      { name: 'Pirkanmaan Tanssin Keskus', url: 'https://www.pirkanmaantanssinkeskus.fi/', group: 'Tampere' },
      { name: 'Porin Teatteri', url: 'http://www.porinteatteri.fi/', group: 'Pori' },
      { name: 'Q-teatteri', url: 'https://www.q-teatteri.fi', group: 'Helsinki' },
      { name: 'Rakastajat-teatteri', url: 'https://rakastajat.fi/', group: 'Pori' },
      { name: 'Rauman teatteri', url: 'http://www.raumanteatteri.fi/', group: 'Rauma' },
      { name: 'Red Nose Company', url: 'https://www.rednose.fi/', group: 'Helsinki' },
      { name: 'Riihimäen Teatteri', url: 'http://www.riihimaenteatteri.fi', group: 'Riihimäki' },
      { name: 'Rovaniemen Teatteri', url: 'http://www.rovaniementeatteri.fi/', group: 'Rovaniemi' },
      { name: 'Ryhmäteatteri', url: 'http://ryhmateatteri.fi', group: 'Helsinki' },
      { name: 'Savonlinnan Teatteri', url: 'http://www.savonlinnanteatteri.fi/', group: 'Savonlinna' },
      { name: 'Seinäjoen kaupunginteatteri', url: 'http://seinajoenkaupunginteatteri.fi/', group: 'Seinäjoki' },
      { name: 'Suomen Kansallisteatteri', url: 'http://www.kansallisteatteri.fi', group: 'Helsinki' },
      { name: 'Suomen Komediateatteri', url: 'http://suomenkomediateatteri.fi', group: 'Helsinki' },
      { name: 'Susanna Leinonen Company', url: 'https://susannaleinonen.com', group: 'Helsinki' },
      { name: 'Svenska Teatern', url: 'http://www.svenskateatern.fi/sv/start/', group: 'Helsinki' },
      { name: 'Tampereen Komediateatteri', url: 'http://www.komediateatteri.fi/', group: 'Tampere' },
      { name: 'Tampereen Työväen Teatteri', url: 'http://www.ttt-teatteri.fi', group: 'Tampere' },
      { name: 'Tampereen Teatteri', url: 'http://www.tampereenteatteri.fi/', group: 'Tampere' },
      { name: 'Tanssiteatteri ERI', url: 'http://www.eri.fi/', group: 'Turku' },
      { name: 'Tanssiteatteri Glims & Gloms', url: 'http://www.glimsgloms.com/', group: 'Espoo' },
      { name: 'Tanssiteatteri Hurjaruuth', url: 'https://www.hurjaruuth.fi/', group: 'Helsinki' },
      { name: 'Tanssiteatteri MD', url: 'http://www.tanssiteatterimd.fi/', group: 'Tampere' },
      { name: 'Tanssiteatteri Minimi', url: 'http://www.minimi.fi/', group: 'Kuopio' },
      { name: 'Tanssiteatteri Raatikko', url: 'http://www.raatikko.fi/', group: 'Vantaa' },
      { name: 'Tanssiteatteri Rimpparemmi', url: 'http://www.rimpparemmi.fi/', group: 'Rovaniemi' },
      { name: 'Tanssiteatteri Tsuumi', url: 'http://www.tsuumi.com/?lang=fi' },
      { name: 'Teater Viirus', url: 'https://www.viirus.fi/', group: 'Helsinki' },
      { name: 'Teatteri Eurooppa Neljä', url: 'http://www.teatterieurooppanelja.fi/', group: 'Jyväskylä' },
      { name: 'Teatteri Hevosenkenkä', url: 'http://www.hevosenkenka.fi', group: 'Espoo' },
      { name: 'Teatteri Imatra', url: 'http://www.teatteri-imatra.fi/', group: 'Imatra' },
      { name: 'Teatteri Jurkka', url: 'http://www.jurkka.fi/', group: 'Helsinki' },
      { name: 'Teatteri Mukamas', url: 'http://www.teatterimukamas.com/', group: 'Tampere' },
      { name: 'Teatteri Rollo', url: 'https://www.rollo.fi' },
      { name: 'Teatteri Vanha Juko', url: 'http://teatterivanhajuko.fi/', group: 'Lahti' },
      { name: 'Teatteri Vantaa', url: 'http://www.teatterivantaa.fi/', group: 'Vantaa' },
      { name: 'Turun Kaupunginteatteri', url: 'https://tkteatteri.fi/', group: 'Turku' },
      { name: 'Unga Teatern', url: 'http://www.ungateatern.fi/', group: 'Espoo' },
      { name: 'Vaasan kaupunginteatteri', url: 'http://www.vaasankaupunginteatteri.fi/', group: 'Vaasa' },
      { name: 'Varkauden Teatteri', url: 'http://www.varkaudenteatteri.fi/', group: 'Varkaus' },
      { name: 'Wasa Teater', url: 'http://www.wasateater.fi/', group: 'Vaasa' },
      { name: 'Zodiak – Uuden tanssin keskus', url: 'http://www.zodiak.fi', group: 'Helsinki' },
    ]
  },
  { 
    ...
    providers: [
      ...
      { name: 'Kotkan seudun joukkoliikenne', url: 'https://www.kotkanaikataulut.fi/', group: 'Joukkoliikennejärjestäjät' },
      ...
      { name: 'Transdev Finland', url: 'https://www.transdev.fi/', group: 'Liikennöitsijät' },
