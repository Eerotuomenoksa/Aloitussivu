...
Pehmeä tuotantoavaus hyväksyttiin 28.8.2026 klo 11.36 ja nykyinen tuotantoversio on 0.77.9. Cloudcity-staging, MariaDB- ja Firestore-siirto, tuotanto-API, ylläpitotunnistus, palvelinasetukset ja suora `/aloitus/`-polku ovat valmiit. Firestore-kirjoituslukko on edelleen voimassa. Palautteen kirjoittava tuotantouusinta on PASS ja testipalaute on käsitelty. Version 1.0.0 ja laajan tiedotuksen päätös on NO-GO, kunnes alla oleva WordPressin P1-linkkivirhe on korjattu, KO-01-seloste hyväksytty ja julkaistu sekä loppuportti hyväksytty.
