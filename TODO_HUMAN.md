...
11. **P1 – julkaisupäivän tuotantotarkistus 1.9., tarvittaessa viimeistään 3.9.:** tarkista canonical-, Open Graph-, sitemap- ja robots-tiedostot, etusivu, tietosuoja, saavutettavuus, sovelluksen suora `/aloitus/`-polku ja `/aloitussivu/`-esittelysivu sekä mobiili- ja työpöytänäkymä oikeassa tuotanto-osoitteessa. Toista myös WordPress-savukoe. Julkaisu hyväksytään vasta, kun tuotannon smoke-testit on läpäisty eikä avoimia P1-havaintoja ole.
