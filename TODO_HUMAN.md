...
3. **P1 – tietosuojaseloste ja kolmannen osapuolen palvelut, päätetty 30.8.2026:** seloste ei mainitse Nominatimia, rss2jsonia, allorigins-palvelua eikä Open-Meteoa, vaikka niille lähtee käyttäjän IP-osoite ja Nominatimille tarkat koordinaatit. Määrittely `docs/codex-tehtava-kolmannen-osapuolen-palvelut-2026-08-30.md` (KO-01…KO-04). **KO-01 eli selosteen täydennys ennen laajaa tiedotusta**; RSS-haun siirto palvelimelle ja Nominatimin korvaaminen omalla kuntahaulla julkaisun jälkeen. Omistaja: kehitys, selosteen tekstin hyväksyy Nina Ziessler.
