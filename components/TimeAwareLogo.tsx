...
const TimeAwareLogo: React.FC<TimeAwareLogoProps> = ({ className = '', phase: phaseOverride, isDarkMode = false }) => {
  ...
  return (
    ...
    >
      ...
      <text x="126" y="47" fontFamily="'DM Sans', Arial, sans-serif" fontSize="24" fontWeight="700" fill={titleFill}>Aloitussivu</text>
      <text x="126" y="75" fontFamily="'DM Sans', Arial, sans-serif" fontSize="24" fontWeight="700" fill={titleFill}>seniorille</text>
      <rect x="126" y="82" width="176" height="2.5" rx="1.5" fill="#c9963a" opacity="0.9" />
      <text x="127" y="101" fontFamily="'DM Sans', Arial, sans-serif" fontSize="11" fill={subtitleFill}>Helppo ja turvallinen pääsy nettiin</text>
    </svg>
  );
};
