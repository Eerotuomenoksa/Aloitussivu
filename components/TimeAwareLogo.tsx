...
const TimeAwareLogo: React.FC<TimeAwareLogoProps> = ({ className = '', phase: phaseOverride, isDarkMode = false }) => {
  ...
  return (
    ...
    >
      ...
      <text x="126" y="47" fontFamily="'DM Sans', Arial, sans-serif" fontSize="24" fontWeight="700" fill={titleFill}>Seniorin</text>
      <text x="126" y="75" fontFamily="'DM Sans', Arial, sans-serif" fontSize="24" fontWeight="700" fill={titleFill}>aloitussivu</text>
